...
//alert('src_kpi_detail.asp?project='+tmp+'&yearmonth='+document.getElementById("yearmonth").value);
parent.frames['src_kpi_detail'].location.href = 'srs_kpi_ontime_missrate.asp?project='+tmp+'&yearmonth='+document.getElementById("yearmonth").value;
}
</script>
</head>
...
<hr noshade>
<!-- show all items -->
<input type='button' value='In Progress throughput' onclick='show_();' style='font-family:verdana;font-size:8pt;'><br>
<!-- show all items that did not make it from Validation straint to rejected -->
<input type='button' value='Rejection rate'         onclick='show2_();' style='font-family:verdana;font-size:8pt;'><br>
